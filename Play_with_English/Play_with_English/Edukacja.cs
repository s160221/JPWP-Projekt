...
namespace Play_with_English
{
    public partial class Edukacja : Form
    {
        ...
        private void panel1_DragDrop(object sender, DragEventArgs e)    // metoda wywolana po upuszczeniu przeciaganego elementu
        {
            ...
            string przedmiot = "";      // zmienna do przechowania nazwy przedmiotu

            foreach (Control c in tlp.Controls)
            {
                if (c is Label)     // wyszukiwanie ukrytej nazwy obrazka
                {
                    przedmiot = c.Text;   // pobranie nazwy obrazka
                }
            }

            if (przedmiot != "Biology")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z biologią!");
            }
            else
            {
        ...
        private void panel2_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (przedmiot != "Chemistry")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z chemią!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel3_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (przedmiot != "Physics")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z fizyką!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel4_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (przedmiot != "Geography")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z geografią!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel5_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z matematyką!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel6_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z językiem polskim!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel7_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (przedmiot != "History")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z historią!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel8_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (przedmiot != "English")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z językiem angielskim!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel9_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z plastyką!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel10_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest obrazek związany z muzyką!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void pomoc_Click(object sender, EventArgs e)
        {
            ...
            tekst.Text = "Celem wybranego etapu jest rozmieszczenie obrazków poprzez przeciąganie tak, aby dopasować je do "
                + "przedmiotów szkolnych (nazwy podane w etykietach), z któtymi są one związane. W przypadku błędnego umieszczenia "
