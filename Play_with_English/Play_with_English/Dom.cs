...
namespace Play_with_English
{
    public partial class Dom : Form
    {
        ...
        private void panel1_DragDrop(object sender, DragEventArgs e)    // metoda wywolana po upuszczeniu przeciaganego elementu
        {
            ...
            string element = "";      // zmienna do przechowania nazwy elementu

            foreach (Control c in tlp.Controls)
            {
                if (c is Label)     // wyszukiwanie ukrytej nazwy obrazka
                {
                    element = c.Text;   // pobranie nazwy obrazka
                }
            }
            ...
            if (element != "Bike")
            {
                ...
                MessageBox.Show("Ten element nie pasuje do garażu!");
            }
            else
            {
        ...
        private void panel2_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("Ten element nie pasuje do kuchni!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel3_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("Ten element nie pasuje do przedpokoju!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel4_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (element != "Bath" && element != "Washing machine")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("Ten element nie pasuje do łazienki!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel5_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (element != "Table" && element != "Armchair")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("Ten element nie pasuje do salonu!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel8_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (element != "Bookshelves")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("Ten element nie pasuje do gabinetu!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel9_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("Ten element nie pasuje do sypialni!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel10_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("Ten element nie pasuje do poddasza!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void test_Click(object sender, EventArgs e)
        {
            ...
            Test.kategoria = @"Dom";   // zawarcie informacji o kategorii, z ktorej bedzie przeprowadzony test
        ...
        private void pomoc_Click(object sender, EventArgs e)
        {
            ...
            tekst.Text = "Celem wybranego etapu jest rozmieszczenie obrazków poprzez przeciąganie tak, aby dopasować je do "
                + "pomieszczeń domu (nazwy pomieszczeń zamieszczono w etykietach), z któtymi są one związane. W przypadku błędnego umieszczenia "
