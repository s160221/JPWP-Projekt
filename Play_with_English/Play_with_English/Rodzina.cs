...
{
    public partial class Rodzina : Form
    {
        ...
        public Rodzina()
        {
            ...
            {
                lab[i].Text = obraz.Key.Split('_')[0];    // uzycie klucza jako etykiety obrazu (angielskie slowo)
        ...
        private void panel1_DragDrop(object sender, DragEventArgs e)    // metoda wywolana po upuszczeniu przeciaganego elementu
        {
            ...
            string osoba = "";      // zmienna do przechowania nazwy czlonka rodziny

            foreach (Control c in tlp.Controls)
            {
                if (c is Label)     // wyszukiwanie ukrytej nazwy obrazka
                {
                    osoba = c.Text;   // pobranie nazwy obrazka
                }
            }
            ...
            if (osoba != "Cousin")
            {
                ...
                MessageBox.Show("To nie jest kuzyn lub kuzynka!");
            }
            else
            {
        ...
        private void panel3_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (osoba != "Brother" && osoba != "Sister")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest brat lub siostra!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel5_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (osoba != "Uncle" && osoba != "Aunt")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest wujek lub ciocia!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel7_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (osoba != "Father" && osoba != "Mother")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest tata lub mama!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void panel9_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (osoba != "Grandfather" && osoba != "Grandmother")
            {
                e.Effect = DragDropEffects.None;
                MessageBox.Show("To nie jest dziadek lub babcia!");
            }
            else
            {
                tlp.Parent = (Panel)sender;     // ustawienie obszaru docelowego jako nowego rodzica przeciagnietego panelu
        ...
        private void test_Click(object sender, EventArgs e)
        {
            ...
            Test.kategoria = "Rodzina";   // zawarcie informacji o kategorii, z ktorej bedzie przeprowadzony test
